...
construct_cell_taxonomy = function(sc_exp, dataset_name, marker_list, num_markers = 50, clust_method = 'average'){
...
interneuron.combined[[]] %>% filter(study %in% c('zeng_10xv2_wba','zeng_10xv3_wba')) %>% 
  group_by(cell_cluster, primate_subclass) %>% summarise(n = n())
