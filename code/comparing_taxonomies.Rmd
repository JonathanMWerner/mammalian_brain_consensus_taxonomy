...
construct_cell_taxonomy = function(sc_exp, dataset_name, marker_list, num_markers = 50){
  ...
  dataset_subclasses = as.data.frame(colData(sc_exp)[ ,c('cell_subclass','cell_cluster','primate_subclass')])
  ...
  column_ha = HeatmapAnnotation(original_subclass = original_subclass, orthologous_subclass = orthologous_subclass,
                                col = list(original_subclass = celltype_color_palette, orthologous_subclass = celltype_color_palette ),
