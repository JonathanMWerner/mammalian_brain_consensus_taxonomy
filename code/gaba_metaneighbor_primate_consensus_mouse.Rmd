...
```{r}
start = Sys.time()
global_hvgs = variableGenes(dat = merged_mouse_sce, exp_labels = merged_mouse_sce$study_id, min_recurrence = 6)
length(global_hvgs)
Sys.time() - start
```

Just use the top 250 hvgs
```{r}
global_hvgs = global_hvgs[1:250]
...
```{r}
r_names = rownames(mouseMC_primate_sub_best_hits)
r_index = grepl('human', r_names) | grepl('chimp', r_names) | grepl('gorilla', r_names) | grepl('macaca', r_names) | grepl('marmoset', r_names) 
c_index = !r_index

test_metasubclass_hits = mouseMC_primate_sub_best_hits[r_index, c_index]
...
index = match(avg_mouse_metaclust_df$study_meta_cluster, as.character(max_avg_mapping$mouse_mcluster))
avg_mouse_metaclust_df$primate_subclass = max_avg_mapping$primate_subclass[index]
avg_mouse_metaclust_df$orthology = max_avg_mapping$orthology[index]
avg_mouse_metaclust_df
```
...
mouseMC_check = avg_mouse_metaclust_primate_sub_df %>% filter(orthology == 'low_orthology') %>% pull(study_meta_cluster)
...
low_orth_lose_df = avg_mouse_metaclust_primate_sub_df %>% filter(!study_meta_cluster %in% refined_mouseMC & orthology == 'low_orthology')
...
low_orth_refine_df = avg_mouse_metaclust_primate_sub_df %>% filter(study_meta_cluster %in% refined_mouseMC)
low_orth_refine_df$primate_subclass = rep(NA, length = nrow(low_orth_refine_df))
#Add in the mapped primate subclasses
low_orth_refine_df$primate_subclass[low_orth_refine_df$study == 'tasic18' & low_orth_refine_df$meta_cluster == 'meta_cluster1'] = 'Sncg'
...
low_orth_refine_df$primate_subclass[low_orth_refine_df$study == 'tasic18' & low_orth_refine_df$meta_cluster == 'meta_cluster18' ] = 'Sst'
low_orth_refine_df$primate_subclass[low_orth_refine_df$study == 'tasic18' & low_orth_refine_df$meta_cluster == 'meta_cluster20' ] = 'Sst'
low_orth_refine_df$primate_subclass[low_orth_refine_df$study == 'tasic18' & low_orth_refine_df$meta_cluster == 'meta_cluster24' ] = 'Sst'
...
low_orth_refine_df$primate_subclass[low_orth_refine_df$study == 'zeng_10x_cells' & low_orth_refine_df$meta_cluster == 'meta_cluster28' ] = 'Sncg'
...
low_orth_refine_df$primate_subclass[low_orth_refine_df$study == 'zeng_smart_cells' & low_orth_refine_df$meta_cluster == 'meta_cluster18' ] = 'Sst'
low_orth_refine_df$primate_subclass[low_orth_refine_df$study == 'zeng_smart_cells' & low_orth_refine_df$meta_cluster == 'meta_cluster20' ] = 'Sst'
...
low_orth_refine_df$primate_subclass[low_orth_refine_df$study == 'zeng_smart_nuclei' & low_orth_refine_df$meta_cluster == 'meta_cluster4' ] = 'Lamp5'
...
low_orth_refine_df$primate_subclass[low_orth_refine_df$study == 'macosko_wba' & low_orth_refine_df$meta_cluster == 'meta_cluster6' ] = 'Pvalb'
...
low_orth_refine_df$primate_subclass[low_orth_refine_df$study == 'zeng_10xv2_wba' & low_orth_refine_df$meta_cluster == 'meta_cluster71' ] = 'Sst'
...
low_orth_refine_df$primate_subclass[low_orth_refine_df$study == 'zeng_10xv3_wba' & low_orth_refine_df$meta_cluster == 'meta_cluster68' ] = 'Sst'
...
low_orth_refine_df$primate_subclass[low_orth_refine_df$study == 'zeng_10xv3_wba' & low_orth_refine_df$meta_cluster == 'meta_cluster71' ] = 'Sst'
...
low_orth_refine_df$primate_subclass[low_orth_refine_df$study == 'zeng_10xv3_wba' & low_orth_refine_df$meta_cluster == 'meta_cluster37' ] = 'Lamp5'
low_orth_refine_df$primate_subclass[low_orth_refine_df$study == 'zeng_10xv3_wba' & low_orth_refine_df$meta_cluster == 'meta_cluster31' ] = 'Sncg'
...
low_orth_refine_df$primate_subclass[low_orth_refine_df$study == 'zeng_10xv3_wba' & low_orth_refine_df$meta_cluster == 'meta_cluster12' ] = 'Pax6'



avg_mouse_metaclust_primate_sub_df = avg_mouse_metaclust_primate_sub_df %>% filter(orthology == 'high_orthology')
...
save(avg_mouse_metaclust_primate_sub_df, 
...
index = match(colnames(test_metasubclass_hits), avg_mouse_metaclust_primate_sub_df$study_meta_cluster )

col_ha = HeatmapAnnotation(orthologous_subclass = avg_mouse_metaclust_primate_sub_df$primate_subclass[index],
...
index = match(mouse_match_prim_sub$Var2,avg_mouse_metaclust_primate_sub_df$study_meta_cluster )

mouse_match_prim_sub$orthologous_subclass = avg_mouse_metaclust_primate_sub_df$primate_subclass[index]
...
mouse_match_prim_sub = mouse_match_prim_sub %>% group_by(Var2, Var1) %>% 
  ...
  arrange(match(orthologous_subclass, 
                c("Sst", "Sst Chodl", "Vip", 'Sncg', 'Pax6', 'Pvalb', 'Chandelier', 'Lamp5 Lhx6', 'Lamp5', 'none')), 
          desc(mean_auroc))
...
```{r}
rm(merged_mammal_sce, merged_mammal_super_sce)
gc()
...
```{r}
study_clusts_df = avg_mouse_metaclust_primate_sub_df %>% filter(study == 'tasic18')
...
tasic18 = tasic18[ ,tasic18$primate_subclass != 'none']


study_clusts_df = avg_mouse_metaclust_primate_sub_df %>% filter(study == 'zeng_10x_cells')
...
zeng_10x_cells= zeng_10x_cells[ ,zeng_10x_cells$primate_subclass != 'none' ]

study_clusts_df = avg_mouse_metaclust_primate_sub_df %>% filter(study == 'zeng_10x_nuclei')
...
zeng_10x_nuclei= zeng_10x_nuclei[ ,zeng_10x_nuclei$primate_subclass != 'none']

study_clusts_df = avg_mouse_metaclust_primate_sub_df %>% filter(study == 'zeng_smart_cells')
...
zeng_smart_cells= zeng_smart_cells[ ,zeng_smart_cells$primate_subclass != 'none']

study_clusts_df = avg_mouse_metaclust_primate_sub_df %>% filter(study == 'zeng_smart_nuclei')
...
zeng_smart_nuclei= zeng_smart_nuclei[ ,zeng_smart_nuclei$primate_subclass != 'none']





study_clusts_df = avg_mouse_metaclust_primate_sub_df %>% filter(study == 'zeng_10xv2_wba')
...
zeng_10xv2_wba= zeng_10xv2_wba[ ,zeng_10xv2_wba$primate_subclass != 'none' ]

study_clusts_df = avg_mouse_metaclust_primate_sub_df %>% filter(study == 'zeng_10xv3_wba')
...
zeng_10xv3_wba= zeng_10xv3_wba[ ,zeng_10xv3_wba$primate_subclass != 'none' ]


study_clusts_df = avg_mouse_metaclust_primate_sub_df %>% filter(study == 'macosko_wba')
...
macosko_wba= macosko_wba[ ,macosko_wba$primate_subclass != 'none' ]
...
```{r}
tasic_in_meta = avg_mouse_metaclust_primate_sub_df %>% filter(study == 'tasic18') %>% pull(cluster)
...
temp_tasic = avg_mouse_metaclust_primate_sub_df %>% filter(study == 'tasic18' & primate_subclass != 'none')
...
temp_tasic$original_subclass[temp_tasic$original_subclass == 'Serpinf1'] = 'Pax6'


#zeng_10x_cells
zeng_10x_cells_in_meta = avg_mouse_metaclust_primate_sub_df %>% filter(study == 'zeng_10x_cells') %>% pull(cluster)
...
temp_zeng_10x_cells = avg_mouse_metaclust_primate_sub_df %>% filter(study == 'zeng_10x_cells'& primate_subclass != 'none')
...
#zeng_10x_nuclei
zeng_10x_nuclei_in_meta = avg_mouse_metaclust_primate_sub_df %>% filter(study == 'zeng_10x_nuclei') %>% pull(cluster)
...
temp_zeng_10x_nuclei = avg_mouse_metaclust_primate_sub_df %>% filter(study == 'zeng_10x_nuclei'& primate_subclass != 'none')
...
#zeng_smart_cells
zeng_smart_cells_in_meta = avg_mouse_metaclust_primate_sub_df %>% filter(study == 'zeng_smart_cells') %>% pull(cluster)
...
temp_zeng_smart_cells = avg_mouse_metaclust_primate_sub_df %>% filter(study == 'zeng_smart_cells'& primate_subclass != 'none')
...
#zeng_smart_nuclei
zeng_smart_nuclei_in_meta = avg_mouse_metaclust_primate_sub_df %>% filter(study == 'zeng_smart_nuclei') %>% pull(cluster)
...
temp_zeng_smart_nuclei = avg_mouse_metaclust_primate_sub_df %>% filter(study == 'zeng_smart_nuclei'& primate_subclass != 'none')
...
#zeng_10xv2_wba
zeng_10xv2_wba_in_meta = avg_mouse_metaclust_primate_sub_df %>% filter(study == 'zeng_10xv2_wba') %>% pull(cluster)
...
temp_zeng_10xv2_wba = avg_mouse_metaclust_primate_sub_df %>% filter(study == 'zeng_10xv2_wba'& primate_subclass != 'none')
...
#zeng_10xv3_wba
zeng_10xv3_wba_in_meta = avg_mouse_metaclust_primate_sub_df %>% filter(study == 'zeng_10xv3_wba') %>% pull(cluster)
...
temp_zeng_10xv3_wba = avg_mouse_metaclust_primate_sub_df %>% filter(study == 'zeng_10xv3_wba'& primate_subclass != 'none')
...
FindIntegrationAnchors took almost 5.5 hours
...
DimPlot(interneuron.combined, group.by = 'original_subclass')
DimPlot(interneuron.combined, group.by = 'primate_subclass')
```
