...
#keep_index = !full_mouse_clusters %in% other_region_clusters
#dim(merged_mouse_sce)
#merged_mouse_sce = merged_mouse_sce[ , keep_index]
#gc()
#dim(merged_mouse_sce)
...
```{r}
# library(tidyverse)
# mouse_mclusters_df = enframe(mouse_mclusters) %>% unnest(cols = c('value'))
# 
# mouse_mclusters_df$study = sapply(strsplit(mouse_mclusters_df$value, split = '|', fixed = T), '[[', 1)
# 
# #Get the number of studies present in each metacluster and whether or not macosko is present
# #Will try only using the metaclusters represented by at least half of the datasets and include macosko. Those will be metaclusters that replicate
# #across the big atlases plus some of the older datasets. Metaclusters with macosko and only 3 studies are likely all of the extra regions sampled in the whole brain atlasses
# mouse_super_metaclusters = mouse_mclusters_df %>% group_by(name) %>% 
#   summarise(num_study = length(unique(study)), macosko_present = c('macosko_wba') %in% study) %>%
#   arrange(desc(num_study))
# 
# mouse_super_metaclusters
# 
...
And now the 1vs best but only using the super mouse metaclusters
Those metaclusters that contain atleast 4 datasets, including the macosko atlas


```{r}
# #Grab the mouse super clusters
# super_clusters = mouse_super_metaclusters %>% filter(num_study >= 4 & macosko_present) %>% pull(name)
# 
# #Filter for the primate subclasses and the mouse super clusters
# current_subclass_metaclusts = colData(merged_mammal_sce)$mouse_metaclust_primate_sub
# keep_index = current_subclass_metaclusts %in% c(super_clusters, 'Lamp5','Lamp5_Lhx6','Vip','Pax6','Sncg','Pvalb','Chandelier','Sst','Sst Chodl' ) & current_subclass_metaclusts != 'outliers'
# table(keep_index)
# merged_mammal_super_sce = merged_mammal_sce[ , keep_index]
# dim(merged_mammal_super_sce)
```

```{r}
# start = Sys.time()
# global_hvgs_super = variableGenes(dat = merged_mammal_super_sce, exp_labels = merged_mammal_super_sce$study_id, min_recurrence = 10)
# length(global_hvgs_super)
# Sys.time() - start
# 
# 
# global_hvgs_super = global_hvgs_super[1:250]
# length(global_hvgs_super)
```

```{r}
# start = Sys.time()
# mammal_mouseSuperMC_best_hits = MetaNeighborUS(var_genes = global_hvgs_super, 
#                               dat = merged_mammal_super_sce, 
#                               study_id = merged_mammal_super_sce$study_id,
#                               cell_type = merged_mammal_super_sce$mouse_metaclust_primate_sub,
#                               fast_version = T,
#                               one_vs_best = T, symmetric_output = F)
# Sys.time() - start
# 
# 
# pdf(file = '/home/werner/projects/mouse_brain_consensus_taxonomy/graphs/metaneighbor_plots/across_mammal_mouseSuperMC_data_1vsbest.pdf', 
#     useDingbats = F, height = 25, width = 25)
# plotHeatmap(mammal_mouseMC_best_hits, cex = .2)
# dev.off()
...
save(mammal_aurocs,mammal_best_hits , mammal_mouseMC_best_hits,
...
#     useDingbats = F, height = 8, width = 20)
# ht_mc_split = ComplexHeatmap::Heatmap(test_metasubclass_hits, name = 'AUROC', col = auroc_cols,
#                         row_order = order.dendrogram(row_dendrogram), cluster_rows = row_dendrogram,
#                         column_order = order.dendrogram(col_dendrogram), cluster_columns = col_dendrogram,
#                         column_names_gp = gpar(fontsize = 4),
#                         row_names_gp = gpar(fontsize = 8),
#                         left_annotation = row_ha,
#                         column_split = 10, row_split = 9)
# ht_mc_split = draw(ht_mc_split)
# dev.off()
...
# meta_clust_groups = column_order(ht_mc_split)
# 
# 
# colnames(test_metasubclass_hits)[meta_clust_groups[[1]]]
# 
# df_1 = data.frame(mouse_meta_cluster = colnames(test_metasubclass_hits)[meta_clust_groups[[1]]], primate_subclass = 'Chandelier' )
# df_2 = data.frame(mouse_meta_cluster = colnames(test_metasubclass_hits)[meta_clust_groups[[2]]], primate_subclass = 'Pvalb' )
# df_3 = data.frame(mouse_meta_cluster = colnames(test_metasubclass_hits)[meta_clust_groups[[3]]], primate_subclass = 'Lamp5 Lhx6' )
# df_4 = data.frame(mouse_meta_cluster = colnames(test_metasubclass_hits)[meta_clust_groups[[4]]], primate_subclass = 'Lamp5' )
# df_5 = data.frame(mouse_meta_cluster = colnames(test_metasubclass_hits)[meta_clust_groups[[5]]], primate_subclass = 'Sst Chodl' )
# df_6 = data.frame(mouse_meta_cluster = colnames(test_metasubclass_hits)[meta_clust_groups[[6]]], primate_subclass = 'Sst' )
# df_7 = data.frame(mouse_meta_cluster = colnames(test_metasubclass_hits)[meta_clust_groups[[7]]], primate_subclass = 'Pax6' )
# df_8 = data.frame(mouse_meta_cluster = colnames(test_metasubclass_hits)[meta_clust_groups[[8]]], primate_subclass = 'Vip' )
# df_9 = data.frame(mouse_meta_cluster = colnames(test_metasubclass_hits)[meta_clust_groups[[9]]], primate_subclass = 'Sncg_Sst_Chodl' )
# df_10 = data.frame(mouse_meta_cluster = colnames(test_metasubclass_hits)[meta_clust_groups[[10]]], primate_subclass = 'Sncg' )
# 
# mouse_metaclust_df = do.call(rbind, list(df_1, df_2, df_3, df_4, df_5, df_6, df_7, df_8, df_9, df_10))
# mouse_metaclust_df
# 
# 
...
And now just the mouse super clusters


And the metacluster annotations
```{r}
# r_names = rownames(mammal_mouseSuperMC_best_hits)
# r_index = grepl('human', r_names) | grepl('chimp', r_names) | grepl('gorilla', r_names) | grepl('macaca', r_names) | grepl('marmoset', r_names) 
# c_index = !r_index
# 
# test_metasubclass_hits = mammal_mouseSuperMC_best_hits[r_index, c_index]
# m = test_metasubclass_hits 
# #Cluster first, need to swap NAs to 0 for clustering
# m[is.na(m)] <- 0
# row_dendrogram <- stats::as.dendrogram(stats::hclust(dist(1-m), method = "ward.D2"))
...
# auroc_cols <- rev(grDevices::colorRampPalette(RColorBrewer::brewer.pal(11,"RdYlBu"))(100))
# 
# ht_Supermc = ComplexHeatmap::Heatmap(test_metasubclass_hits, name = 'AUROC', col = auroc_cols,
#                         row_order = order.dendrogram(row_dendrogram), cluster_rows = row_dendrogram,
#                         column_order = order.dendrogram(col_dendrogram), cluster_columns = col_dendrogram,
#                         column_names_gp = gpar(fontsize = 4),
#                         row_names_gp = gpar(fontsize = 8),
...
# 
# ht_Supermc = draw(ht_Supermc)
# 
# 
# pdf(file = '/home/werner/projects/mouse_brain_consensus_taxonomy/graphs/metaneighbor_plots/primate_subclass_mouse_Supermetacluster_heatmap.pdf',
#     useDingbats = F, height = 8, width = 15)
# ht_mc = ComplexHeatmap::Heatmap(test_metasubclass_hits, name = 'AUROC', col = auroc_cols,
#                         row_order = order.dendrogram(row_dendrogram), cluster_rows = row_dendrogram,
#                         column_order = order.dendrogram(col_dendrogram), cluster_columns = col_dendrogram,
...
# dev.off()
# 
# pdf(file = '/home/werner/projects/mouse_brain_consensus_taxonomy/graphs/metaneighbor_plots/split_primate_subclass_mouse_Supermetacluster_heatmap.pdf',
#     useDingbats = F, height = 8, width = 15)
# ht_mc_split = ComplexHeatmap::Heatmap(test_metasubclass_hits, name = 'AUROC', col = auroc_cols,
#                         row_order = order.dendrogram(row_dendrogram), cluster_rows = row_dendrogram,
#                         column_order = order.dendrogram(col_dendrogram), cluster_columns = col_dendrogram,
...
#df_3 = data.frame(mouse_meta_cluster = colnames(test_metasubclass_hits)[meta_clust_groups[[3]]], primate_subclass = 'Chandelier' )
#df_4 = data.frame(mouse_meta_cluster = colnames(test_metasubclass_hits)[meta_clust_groups[[4]]], primate_subclass = 'Pvalb_Sst' )
#df_5 = data.frame(mouse_meta_cluster = colnames(test_metasubclass_hits)[meta_clust_groups[[5]]], primate_subclass = 'Pvalb' )
#df_6 = data.frame(mouse_meta_cluster = colnames(test_metasubclass_hits)[meta_clust_groups[[6]]], primate_subclass = 'Lamp5 Lhx6' )
#df_7 = data.frame(mouse_meta_cluster = colnames(test_metasubclass_hits)[meta_clust_groups[[7]]], primate_subclass = 'Lamp5' )
#df_8 = data.frame(mouse_meta_cluster = colnames(test_metasubclass_hits)[meta_clust_groups[[8]]], primate_subclass = 'Pax6_Sncg' )
#df_9 = data.frame(mouse_meta_cluster = colnames(test_metasubclass_hits)[meta_clust_groups[[9]]], primate_subclass = 'Pax6' )
#df_10 = data.frame(mouse_meta_cluster = colnames(test_metasubclass_hits)[meta_clust_groups[[10]]], primate_subclass = 'Vip' )
#df_11 = data.frame(mouse_meta_cluster = colnames(test_metasubclass_hits)[meta_clust_groups[[11]]], primate_subclass = 'Sncg' )

#mouse_metaclust_df = do.call(rbind, list(df_1, df_2, df_3, df_4, df_5, df_6, df_7, df_8, df_9, df_10, df_11))
#mouse_metaclust_df
...
```{r}
study_clusts_df = avg_mouse_metaclust_df %>% filter(study == 'tasic18')
...
study_clusts_df = avg_mouse_metaclust_df %>% filter(study == 'zeng_10x_cells')
...
study_clusts_df = avg_mouse_metaclust_df %>% filter(study == 'zeng_10x_nuclei')
...
study_clusts_df = avg_mouse_metaclust_df %>% filter(study == 'zeng_smart_cells')
...
study_clusts_df = avg_mouse_metaclust_df %>% filter(study == 'zeng_smart_nuclei')
...
study_clusts_df = avg_mouse_metaclust_df %>% filter(study == 'zeng_10xv2_wba')
...
study_clusts_df = avg_mouse_metaclust_df %>% filter(study == 'zeng_10xv3_wba')
...
study_clusts_df = avg_mouse_metaclust_df %>% filter(study == 'macosko_wba')
...
#Filter out the outlier clusters
...
celltype_color_palette = c("Chandelier"='#F641A8', 
                           ...
                           "Lamp5_Lhx6"='#935F50',
                           "Pax6"='#71238C',
                           'Pvalb_Sst' = 'grey', 'Pax6_Sncg' = 'grey50',
                           'Serpinf1' = 'grey20')
...
zeng_10xv2_wba$subclass_label[zeng_10xv2_wba$subclass_label == 'Lamp5 Lhx6 Gaba'] = 'Lamp5_Lhx6'
...
zeng_10xv3_wba$subclass_label[zeng_10xv3_wba$subclass_label == 'Lamp5 Lhx6 Gaba'] = 'Lamp5_Lhx6'
...
umap_1 = DimPlot(zeng_10x_cells, reduction = "umap", group.by = 'primate_subclass', cols = celltype_color_palette) + ggtitle('zeng_10x_cells new primate subclass')
umap_1
...
umap_1 = DimPlot(zeng_10x_nuclei, reduction = "umap", group.by = 'primate_subclass', cols = celltype_color_palette) + ggtitle('zeng_10x_nuclei new primate subclass')
umap_1
...
umap_1 = DimPlot(zeng_smart_cells, reduction = "umap", group.by = 'primate_subclass', cols = celltype_color_palette) + ggtitle('zeng_smart_cells new primate subclass')
umap_1
...
umap_1 = DimPlot(zeng_smart_nuclei, reduction = "umap", group.by = 'primate_subclass', cols = celltype_color_palette) + ggtitle('zeng_smart_nuclei new primate subclass')
umap_1
...
```{r}
tasic_in_meta = avg_mouse_metaclust_df %>% filter(study == 'tasic18') %>% pull(cluster)
...
temp_tasic = avg_mouse_metaclust_df %>% filter(study == 'tasic18')
...
#zeng_10x_cells
zeng_10x_cells_in_meta = avg_mouse_metaclust_df %>% filter(study == 'zeng_10x_cells') %>% pull(cluster)
...
temp_zeng_10x_cells = avg_mouse_metaclust_df %>% filter(study == 'zeng_10x_cells')
...
#zeng_10x_nuclei
zeng_10x_nuclei_in_meta = avg_mouse_metaclust_df %>% filter(study == 'zeng_10x_nuclei') %>% pull(cluster)
...
temp_zeng_10x_nuclei = avg_mouse_metaclust_df %>% filter(study == 'zeng_10x_nuclei')
...
#zeng_smart_cells
zeng_smart_cells_in_meta = avg_mouse_metaclust_df %>% filter(study == 'zeng_smart_cells') %>% pull(cluster)
...
temp_zeng_smart_cells = avg_mouse_metaclust_df %>% filter(study == 'zeng_smart_cells')
...
#zeng_smart_nuclei
zeng_smart_nuclei_in_meta = avg_mouse_metaclust_df %>% filter(study == 'zeng_smart_nuclei') %>% pull(cluster)
...
temp_zeng_smart_nuclei = avg_mouse_metaclust_df %>% filter(study == 'zeng_smart_nuclei')
...
#zeng_10xv2_wba
zeng_10xv2_wba_in_meta = avg_mouse_metaclust_df %>% filter(study == 'zeng_10xv2_wba') %>% pull(cluster)
...
temp_zeng_10xv2_wba = avg_mouse_metaclust_df %>% filter(study == 'zeng_10xv2_wba')
...
#zeng_10xv3_wba
zeng_10xv3_wba_in_meta = avg_mouse_metaclust_df %>% filter(study == 'zeng_10xv3_wba') %>% pull(cluster)
...
temp_zeng_10xv3_wba = avg_mouse_metaclust_df %>% filter(study == 'zeng_10xv3_wba')
