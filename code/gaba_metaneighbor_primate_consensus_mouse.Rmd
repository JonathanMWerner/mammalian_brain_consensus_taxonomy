...
save(mouse_aurocs, mouse_best_hits , mouse_mclusters, mouse_super_metaclusters,
...
save(mammal_aurocs,mammal_best_hits , mammal_mouseMC_best_hits, mammal_mouseSuperMC_best_hits, 
...
df_4 = data.frame(mouse_meta_cluster = colnames(test_metasubclass_hits)[meta_clust_groups[[4]]], primate_subclass = 'Pvalb' )
...
df_10 = data.frame(mouse_meta_cluster = colnames(test_metasubclass_hits)[meta_clust_groups[[10]]], primate_subclass = 'Pax6_Sncg' )
...
mouse_super_metaclusters %>% filter(num_study >= 4 & macosko_present) %>% pull(name)

mouse_mclusters$meta_cluster32
