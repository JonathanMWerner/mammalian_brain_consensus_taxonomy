...
#save source data
```{r}
save(centroid_corr, dataset_subclasses, file = '../../source_data/data_for_plots/integrated_mouse_taxonomy.Rdata')
```
...
sankey_interneuron_df = interneuron.combined[[]] %>% dplyr::rename(original_subclass = cell_subclass, orthologous_subclass = primate_subclass) %>%
...
#save source data
```{r}
save(sankey_interneuron_df, file = '../../source_data/data_for_plots/subclass_sankey.Rdata')
```
