...
rownames(interneuron.combined)[grepl('ID2',rownames(interneuron.combined) )]


interneuron.combined[[]]

DefaultAssay(object = interneuron.combined) = 'integrated'
FeaturePlot(interneuron.combined, features = 'CCK', slot = 'scale.data') +
  scale_color_gradient2(low = '#313695', mid ='grey95', high = '#A50026', midpoint = 0 )

FeaturePlot(interneuron.combined, features = 'ID2', slot = 'scale.data') +
  scale_color_gradient2(low = '#313695', mid ='grey95', high = '#A50026', midpoint = 0 )
