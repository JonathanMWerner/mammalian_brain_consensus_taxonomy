...
keep_meta = colData(human_10x)[ , c('subclass_label','confirmed_subclass','cluster_label')]
...
keep_meta = colData(human_ss)[ , c('subclass_label','confirmed_subclass','cluster_label')]
...
keep_meta = colData(chimp_10x)[ , c('subclass_label','confirmed_subclass','cluster_label')]
...
keep_meta = colData(chimp_ss)[ , c('subclass_label','confirmed_subclass','cluster_label')]
...
keep_meta = colData(gorilla_10x)[ , c('subclass_label','confirmed_subclass','cluster_label')]
...
keep_meta = colData(gorilla_ss)[ , c('subclass_label','confirmed_subclass','cluster_label')]
...
keep_meta = colData(macaca_10x)[ , c('subclass_label','confirmed_subclass','cluster_label')]
...
keep_meta = colData(marmoset_10x)[ , c('subclass_label','confirmed_subclass','cluster_label')]
...
Make metamarkers using the supplemental table subclass labels
...
And then make metamarkers using the confirmed_subclass_labels
...
conf_markers_human_10x = compute_markers(assay(human_10x, "cpm"), human_10x$confirmed_subclass)
conf_markers_human_ss = compute_markers(assay(human_ss, "cpm"), human_ss$confirmed_subclass)

conf_markers_chimp_10x = compute_markers(assay(chimp_10x, "cpm"), chimp_10x$confirmed_subclass)
conf_markers_chimp_ss = compute_markers(assay(chimp_ss, "cpm"), chimp_ss$confirmed_subclass)

conf_markers_gorilla_10x = compute_markers(assay(gorilla_10x, "cpm"), gorilla_10x$confirmed_subclass)
conf_markers_gorilla_ss = compute_markers(assay(gorilla_ss, "cpm"), gorilla_ss$confirmed_subclass)

conf_markers_macaca_10x = compute_markers(assay(macaca_10x, "cpm"), macaca_10x$confirmed_subclass)

conf_markers_marmoset_10x = compute_markers(assay(marmoset_10x, "cpm"), marmoset_10x$confirmed_subclass)
...
export_markers(conf_markers_human_10x, "metamarkers/conf_markers_human_10x.csv")
export_markers(conf_markers_human_ss, "metamarkers/conf_markers_human_ss.csv")
export_markers(conf_markers_chimp_10x, "metamarkers/conf_markers_chimp_10x.csv")
export_markers(conf_markers_chimp_ss, "metamarkers/conf_markers_chimp_ss.csv")
export_markers(conf_markers_gorilla_10x, "metamarkers/conf_markers_gorilla_10x.csv")
export_markers(conf_markers_gorilla_ss, "metamarkers/conf_markers_gorilla_ss.csv")
export_markers(conf_markers_macaca_10x, "metamarkers/conf_markers_macaca_10x.csv")
export_markers(conf_markers_marmoset_10x, "metamarkers/conf_markers_marmoset_10x.csv")
...
And do a cross-mammal metamarkers

```{r}
mammal_subclass_markers = list(
    human_10x = read_markers("../metamarkers/markers_human_10x.csv.gz"),
    human_ss = read_markers("../metamarkers/markers_human_ss.csv.gz"),
    chimp_10x = read_markers("../metamarkers/markers_chimp_10x.csv.gz"),
    chimp_ss = read_markers("../metamarkers/markers_chimp_ss.csv.gz"),
...
mammal_subclass_markers$human_10x$cell_type[mammal_subclass_markers$human_10x$cell_type == 'Lamp5_Lhx6'] = 'Lamp5 Lhx6'
mammal_subclass_markers$human_ss$cell_type[mammal_subclass_markers$human_ss$cell_type == 'Lamp5_Lhx6'] = 'Lamp5 Lhx6'
mammal_subclass_markers$chimp_10x$cell_type[mammal_subclass_markers$chimp_10x$cell_type == 'Lamp5_Lhx6'] = 'Lamp5 Lhx6'
mammal_subclass_markers$chimp_ss$cell_type[mammal_subclass_markers$chimp_ss$cell_type == 'Lamp5_Lhx6'] = 'Lamp5 Lhx6'
mammal_subclass_markers$gorilla_10x$cell_type[mammal_subclass_markers$gorilla_10x$cell_type == 'Lamp5_Lhx6'] = 'Lamp5 Lhx6'
mammal_subclass_markers$gorilla_ss$cell_type[mammal_subclass_markers$gorilla_ss$cell_type == 'Lamp5_Lhx6'] = 'Lamp5 Lhx6'

mammal_subclass_markers$macaca_10x$cell_type[mammal_subclass_markers$macaca_10x$cell_type == 'Lamp5_Lhx6'] = 'Lamp5 Lhx6'
mammal_subclass_markers$marmoset_10x$cell_type[mammal_subclass_markers$marmoset_10x$cell_type == 'Lamp5_Lhx6'] = 'Lamp5 Lhx6'



mammal_subclass_meta_markers = make_meta_markers(mammal_subclass_markers, detailed_stats = TRUE)

export_meta_markers(mammal_subclass_meta_markers, "../metamarkers/mammal_meta_markers.csv", names(mammal_subclass_markers))


mammal_subclass_meta_markers %>% filter(rank <= 10)
...
primate_subclass_meta_markers$cell_type[primate_subclass_meta_markers$cell_type == 'Lamp5_Lhx6'] = 'Lamp5 Lhx6'
...
pax6_prim_df = primate_subclass_meta_markers %>% filter(gene == 'PAX6')
pax6_prim_df$sub_label = pax6_prim_df$cell_type
pax6_prim_df$sub_label[!pax6_prim_df$sub_label %in% c('Sncg', 'Pax6')] = ''

p_pax6_plot = ggplot(pax6_prim_df, aes(x = log2(fold_change), y = auroc, color = cell_type, label = sub_label)) +
  geom_point(size = 4, show.legend = F, alpha = .75) +
  xlim(-4, 5) + ylim(.35, .9) +
  geom_label_repel(show.legend = F, nudge_x = -1, nudge_y = .1, min.segment.length = 0) +
  scale_color_manual(values = celltype_color_palette) + theme_classic() + theme(aspect.ratio = 1)
p_pax6_plot 

ggsave(plot = p_pax6_plot, filename = 'primate_sub_MM_pax6_DE_scatter.pdf', device = 'pdf',
       path = '/home/werner/projects/mouse_brain_consensus_taxonomy/graphs/meta_markers/',
       useDingbats = F, height = 2, width = 2)

sncg_prim_df = primate_subclass_meta_markers %>% filter(gene == 'SNCG')
sncg_prim_df$sub_label = sncg_prim_df$cell_type
sncg_prim_df$sub_label[!sncg_prim_df$sub_label %in% c('Sncg', 'Pax6')] = ''

p_sncg_plot = ggplot(sncg_prim_df, aes(x = log2(fold_change), y = auroc, color = cell_type, label = sub_label)) +
  geom_point(size = 4, show.legend = F, alpha = .75) +
  xlim(-4, 5) + ylim(.35, .9) +
  geom_label_repel(show.legend = F, nudge_x = -1.5, nudge_y = .1, min.segment.length = 0) +
  scale_color_manual(values = celltype_color_palette) + theme_classic() + theme(aspect.ratio = 1)
p_sncg_plot 

ggsave(plot = p_sncg_plot, filename = 'primate_sub_MM_sncg_DE_scatter.pdf', device = 'pdf',
       path = '/home/werner/projects/mouse_brain_consensus_taxonomy/graphs/meta_markers/',
       useDingbats = F, height = 2, width = 2)
...
pax6_mouse_df = ortho_mouse_subclass_meta_markers %>% filter(gene == 'PAX6')
pax6_mouse_df$sub_label = pax6_mouse_df$cell_type
pax6_mouse_df$sub_label[!pax6_mouse_df$sub_label %in% c('Sncg', 'Pax6')] = ''

p_pax6_plot = ggplot(pax6_mouse_df, aes(x = log2(fold_change), y = auroc, color = cell_type, label = sub_label)) +
  geom_point(size = 4, show.legend = F, alpha = .75) +
  xlim(-4, 5) + ylim(.35, .9) +
  geom_label_repel(show.legend = F, nudge_x = -1, nudge_y = .1, min.segment.length = 0) +
  scale_color_manual(values = celltype_color_palette) + theme_classic() + theme(aspect.ratio = 1)
...
ggsave(plot = p_pax6_plot, filename = 'mouse_sub_MM_pax6_DE_scatter.pdf', device = 'pdf',
       path = '/home/werner/projects/mouse_brain_consensus_taxonomy/graphs/meta_markers/',
       useDingbats = F, height = 2, width = 2)

sncg_mouse_df = ortho_mouse_subclass_meta_markers  %>% filter(gene == 'SNCG')
sncg_mouse_df$sub_label = sncg_mouse_df$cell_type
sncg_mouse_df$sub_label[!sncg_mouse_df$sub_label %in% c('Sncg', 'Pax6')] = ''

p_sncg_plot = ggplot(sncg_mouse_df, aes(x = log2(fold_change), y = auroc, color = cell_type, label = sub_label)) +
  geom_point(size = 4, show.legend = F, alpha = .75) +
  xlim(-4, 5) + ylim(.35, .9) +
  geom_label_repel(show.legend = F, nudge_x = -1, nudge_y = .1, min.segment.length = 0) +
  scale_color_manual(values = celltype_color_palette) + theme_classic() + theme(aspect.ratio = 1)
...
ggsave(plot = p_sncg_plot, filename = 'mouse_sub_MM_sncg_DE_scatter.pdf', device = 'pdf',
       path = '/home/werner/projects/mouse_brain_consensus_taxonomy/graphs/meta_markers/',
       useDingbats = F, height = 2, width = 2)
...
for(i in 1:length(all_cell_types)){
  ...
  g1 = ggplot(de_stats, aes(x = log2(fold_change), y = auroc, label = gene_label)) + 
    ...
    geom_label_repel(max.overlaps = Inf,min.segment.length = 0, 
                     nudge_x = 5, direction = "both", force = 10,
  ...
  file_name = paste0(gsub(' ', '_', current_cell_type), '_cross_mammal_MM_scatter.pdf')
  ggsave(plot = g1, filename = file_name,
         path = '/home/werner/projects/mouse_brain_consensus_taxonomy/graphs/meta_markers/',
         useDingbats = F, height = 6, width = 8, device = 'pdf')
...
Get a plot of Pax6s DE stats across the primate clusters, colored by subclass, then Sncg
Same with the mouse clusters

```{r}

all_species_markers[1]
