...
FeaturePlot(caglayan_inhib_copy, features = 'PAX6', slot = 'data')
FeaturePlot(caglayan_inhib_copy, features = 'MAML2', slot = 'data')
FeaturePlot(caglayan_inhib_copy, features = 'RELN', slot = 'data')
FeaturePlot(caglayan_inhib_copy, features = 'SORCS3', slot = 'data')

FeaturePlot(caglayan_inhib_copy, features = 'CXCL14', slot = 'data')
FeaturePlot(caglayan_inhib_copy, features = 'RXRG', slot = 'data')
FeaturePlot(caglayan_inhib_copy, features = 'KCNG1', slot = 'data')
FeaturePlot(caglayan_inhib_copy, features = 'NPAS3', slot = 'data')
```
