...
saveRDS(sesten_mouse_aurocs, 
        file = '/home/werner/projects/mouse_brain_consensus_taxonomy/data/metaneighbor/non_allen_data/sesten_vs_mouse_full_aurocs.rds')

```

```{r}

sesten_mouse_best_hits = readRDS(file = '/home/werner/projects/mouse_brain_consensus_taxonomy/data/metaneighbor/non_allen_data/sesten_vs_mouse_1vsbestMN.rds')


merged_sesten_mouse = readRDS(file = '/home/werner/projects/mouse_brain_consensus_taxonomy/data/metaneighbor/non_allen_data/merged_sesten_mouse_sce.rds')
...
cluster_graph = makeClusterGraph(sesten_mouse_subclass_best_hits , low_threshold = .5)
