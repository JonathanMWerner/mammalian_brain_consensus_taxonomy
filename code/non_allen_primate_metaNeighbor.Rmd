...
get_hierarch_clust = function(sce_obj, cluster_markers, num_markers, plot_title){
...
sesten_human$agg_vip = get_agg_exp(primate_subclass_meta_markers, 'Vip', num_primate_markers, sesten_human)
sesten_human$agg_pax6 = get_agg_exp(primate_subclass_meta_markers, 'Pax6', num_primate_markers, sesten_human)
sesten_human$agg_sncg = get_agg_exp(primate_subclass_meta_markers, 'Sncg', num_primate_markers, sesten_human)
sesten_human$agg_lamp5 = get_agg_exp(primate_subclass_meta_markers, 'Lamp5', num_primate_markers, sesten_human)
sesten_human$agg_lamp5_lhx6 = get_agg_exp(primate_subclass_meta_markers, 'Lamp5 Lhx6', num_primate_markers, sesten_human)
sesten_human$agg_pvalb = get_agg_exp(primate_subclass_meta_markers, 'Pvalb', num_primate_markers, sesten_human)
sesten_human$agg_chandelier = get_agg_exp(primate_subclass_meta_markers, 'Chandelier', num_primate_markers, sesten_human)
sesten_human$agg_sst = get_agg_exp(primate_subclass_meta_markers, 'Sst', num_primate_markers, sesten_human)
sesten_human$agg_sst_chodl = get_agg_exp(primate_subclass_meta_markers, 'Sst Chodl', num_primate_markers, sesten_human)
...
sesten_human_hierarch_plot = get_hierarch_clust(sesten_human, sesten_human_cluster_markers , 
                                                num_markers = 50,'Sestan Human clusters: Allen primate MetaMarkers')
sesten_human_hierarch_plot

sesten_human$agg_vip = get_agg_exp(mouse_subclass_meta_markers, 'Vip', num_mouse_markers, sesten_human)
sesten_human$agg_pax6 = get_agg_exp(mouse_subclass_meta_markers, 'Pax6', num_mouse_markers, sesten_human)
sesten_human$agg_sncg = get_agg_exp(mouse_subclass_meta_markers, 'Sncg', num_mouse_markers, sesten_human)
sesten_human$agg_lamp5 = get_agg_exp(mouse_subclass_meta_markers, 'Lamp5', num_mouse_markers, sesten_human)
sesten_human$agg_lamp5_lhx6 = get_agg_exp(mouse_subclass_meta_markers, 'Lamp5 Lhx6', num_mouse_markers, sesten_human)
sesten_human$agg_pvalb = get_agg_exp(mouse_subclass_meta_markers, 'Pvalb', num_mouse_markers, sesten_human)
sesten_human$agg_chandelier = get_agg_exp(mouse_subclass_meta_markers, 'Chandelier', num_mouse_markers, sesten_human)
sesten_human$agg_sst = get_agg_exp(mouse_subclass_meta_markers, 'Sst', num_mouse_markers, sesten_human)
sesten_human$agg_sst_chodl = get_agg_exp(mouse_subclass_meta_markers, 'Sst Chodl', num_mouse_markers, sesten_human)

#Alltogether in a hierarchical clustered plot
sesten_human_hierarch_plot = get_hierarch_clust(sesten_human, sesten_human_cluster_markers , 
                                                num_markers = 50,'Sestan Human clusters: Mouse MetaMarkers')
sesten_human_hierarch_plot
...
sesten_chimp$agg_vip = get_agg_exp(primate_subclass_meta_markers, 'Vip', num_primate_markers, sesten_chimp)
sesten_chimp$agg_pax6 = get_agg_exp(primate_subclass_meta_markers, 'Pax6', num_primate_markers, sesten_chimp)
sesten_chimp$agg_sncg = get_agg_exp(primate_subclass_meta_markers, 'Sncg', num_primate_markers, sesten_chimp)
sesten_chimp$agg_lamp5 = get_agg_exp(primate_subclass_meta_markers, 'Lamp5', num_primate_markers, sesten_chimp)
sesten_chimp$agg_lamp5_lhx6 = get_agg_exp(primate_subclass_meta_markers, 'Lamp5 Lhx6', num_primate_markers, sesten_chimp)
sesten_chimp$agg_pvalb = get_agg_exp(primate_subclass_meta_markers, 'Pvalb', num_primate_markers, sesten_chimp)
sesten_chimp$agg_chandelier = get_agg_exp(primate_subclass_meta_markers, 'Chandelier', num_primate_markers, sesten_chimp)
sesten_chimp$agg_sst = get_agg_exp(primate_subclass_meta_markers, 'Sst', num_primate_markers, sesten_chimp)
sesten_chimp$agg_sst_chodl = get_agg_exp(primate_subclass_meta_markers, 'Sst Chodl', num_primate_markers, sesten_chimp)
...
sesten_chimp_hierarch_plot = get_hierarch_clust(sesten_chimp, sesten_chimp_cluster_markers , 
                                                num_markers = 50,'Sestan Chimp clusters: Allen primate MetaMarkers')
sesten_chimp_hierarch_plot

sesten_chimp$agg_vip = get_agg_exp(mouse_subclass_meta_markers, 'Vip', num_mouse_markers, sesten_chimp)
sesten_chimp$agg_pax6 = get_agg_exp(mouse_subclass_meta_markers, 'Pax6', num_mouse_markers, sesten_chimp)
sesten_chimp$agg_sncg = get_agg_exp(mouse_subclass_meta_markers, 'Sncg', num_mouse_markers, sesten_chimp)
sesten_chimp$agg_lamp5 = get_agg_exp(mouse_subclass_meta_markers, 'Lamp5', num_mouse_markers, sesten_chimp)
sesten_chimp$agg_lamp5_lhx6 = get_agg_exp(mouse_subclass_meta_markers, 'Lamp5 Lhx6', num_mouse_markers, sesten_chimp)
sesten_chimp$agg_pvalb = get_agg_exp(mouse_subclass_meta_markers, 'Pvalb', num_mouse_markers, sesten_chimp)
sesten_chimp$agg_chandelier = get_agg_exp(mouse_subclass_meta_markers, 'Chandelier', num_mouse_markers, sesten_chimp)
sesten_chimp$agg_sst = get_agg_exp(mouse_subclass_meta_markers, 'Sst', num_mouse_markers, sesten_chimp)
sesten_chimp$agg_sst_chodl = get_agg_exp(mouse_subclass_meta_markers, 'Sst Chodl', num_mouse_markers, sesten_chimp)

#Alltogether in a hierarchical clustered plot
sesten_chimp_hierarch_plot = get_hierarch_clust(sesten_chimp, sesten_chimp_cluster_markers , 
                                                num_markers = 50,'Sestan chimp clusters: Mouse MetaMarkers')
sesten_chimp_hierarch_plot
...
sesten_macaque$agg_vip = get_agg_exp(primate_subclass_meta_markers, 'Vip', num_primate_markers, sesten_macaque)
sesten_macaque$agg_pax6 = get_agg_exp(primate_subclass_meta_markers, 'Pax6', num_primate_markers, sesten_macaque)
sesten_macaque$agg_sncg = get_agg_exp(primate_subclass_meta_markers, 'Sncg', num_primate_markers, sesten_macaque)
sesten_macaque$agg_lamp5 = get_agg_exp(primate_subclass_meta_markers, 'Lamp5', num_primate_markers, sesten_macaque)
sesten_macaque$agg_lamp5_lhx6 = get_agg_exp(primate_subclass_meta_markers, 'Lamp5 Lhx6', num_primate_markers, sesten_macaque)
sesten_macaque$agg_pvalb = get_agg_exp(primate_subclass_meta_markers, 'Pvalb', num_primate_markers, sesten_macaque)
sesten_macaque$agg_chandelier = get_agg_exp(primate_subclass_meta_markers, 'Chandelier', num_primate_markers, sesten_macaque)
sesten_macaque$agg_sst = get_agg_exp(primate_subclass_meta_markers, 'Sst', num_primate_markers, sesten_macaque)
sesten_macaque$agg_sst_chodl = get_agg_exp(primate_subclass_meta_markers, 'Sst Chodl', num_primate_markers, sesten_macaque)
...
sesten_macaque_hierarch_plot = get_hierarch_clust(sesten_macaque, sesten_macaque_cluster_markers , 
                                                num_markers = 50,'Sestan macaque clusters: Allen primate MetaMarkers')
sesten_macaque_hierarch_plot

sesten_macaque$agg_vip = get_agg_exp(mouse_subclass_meta_markers, 'Vip', num_mouse_markers, sesten_macaque)
sesten_macaque$agg_pax6 = get_agg_exp(mouse_subclass_meta_markers, 'Pax6', num_mouse_markers, sesten_macaque)
sesten_macaque$agg_sncg = get_agg_exp(mouse_subclass_meta_markers, 'Sncg', num_mouse_markers, sesten_macaque)
sesten_macaque$agg_lamp5 = get_agg_exp(mouse_subclass_meta_markers, 'Lamp5', num_mouse_markers, sesten_macaque)
sesten_macaque$agg_lamp5_lhx6 = get_agg_exp(mouse_subclass_meta_markers, 'Lamp5 Lhx6', num_mouse_markers, sesten_macaque)
sesten_macaque$agg_pvalb = get_agg_exp(mouse_subclass_meta_markers, 'Pvalb', num_mouse_markers, sesten_macaque)
sesten_macaque$agg_chandelier = get_agg_exp(mouse_subclass_meta_markers, 'Chandelier', num_mouse_markers, sesten_macaque)
sesten_macaque$agg_sst = get_agg_exp(mouse_subclass_meta_markers, 'Sst', num_mouse_markers, sesten_macaque)
sesten_macaque$agg_sst_chodl = get_agg_exp(mouse_subclass_meta_markers, 'Sst Chodl', num_mouse_markers, sesten_macaque)

#Alltogether in a hierarchical clustered plot
sesten_macaque_hierarch_plot = get_hierarch_clust(sesten_macaque, sesten_macaque_cluster_markers , 
                                                num_markers = 50,'Sestan macaque clusters: Mouse MetaMarkers')
sesten_macaque_hierarch_plot
...
sesten_marmoset$agg_vip = get_agg_exp(primate_subclass_meta_markers, 'Vip', num_primate_markers, sesten_marmoset)
sesten_marmoset$agg_pax6 = get_agg_exp(primate_subclass_meta_markers, 'Pax6', num_primate_markers, sesten_marmoset)
sesten_marmoset$agg_sncg = get_agg_exp(primate_subclass_meta_markers, 'Sncg', num_primate_markers, sesten_marmoset)
sesten_marmoset$agg_lamp5 = get_agg_exp(primate_subclass_meta_markers, 'Lamp5', num_primate_markers, sesten_marmoset)
sesten_marmoset$agg_lamp5_lhx6 = get_agg_exp(primate_subclass_meta_markers, 'Lamp5 Lhx6', num_primate_markers, sesten_marmoset)
sesten_marmoset$agg_pvalb = get_agg_exp(primate_subclass_meta_markers, 'Pvalb', num_primate_markers, sesten_marmoset)
sesten_marmoset$agg_chandelier = get_agg_exp(primate_subclass_meta_markers, 'Chandelier', num_primate_markers, sesten_marmoset)
sesten_marmoset$agg_sst = get_agg_exp(primate_subclass_meta_markers, 'Sst', num_primate_markers, sesten_marmoset)
sesten_marmoset$agg_sst_chodl = get_agg_exp(primate_subclass_meta_markers, 'Sst Chodl', num_primate_markers, sesten_marmoset)
...
sesten_marmoset_hierarch_plot = get_hierarch_clust(sesten_marmoset, sesten_marmoset_cluster_markers , 
                                                num_markers = 50,'Sestan marmoset clusters: Allen primate MetaMarkers')
sesten_marmoset_hierarch_plot

sesten_marmoset$agg_vip = get_agg_exp(mouse_subclass_meta_markers, 'Vip', num_mouse_markers, sesten_marmoset)
sesten_marmoset$agg_pax6 = get_agg_exp(mouse_subclass_meta_markers, 'Pax6', num_mouse_markers, sesten_marmoset)
sesten_marmoset$agg_sncg = get_agg_exp(mouse_subclass_meta_markers, 'Sncg', num_mouse_markers, sesten_marmoset)
sesten_marmoset$agg_lamp5 = get_agg_exp(mouse_subclass_meta_markers, 'Lamp5', num_mouse_markers, sesten_marmoset)
sesten_marmoset$agg_lamp5_lhx6 = get_agg_exp(mouse_subclass_meta_markers, 'Lamp5 Lhx6', num_mouse_markers, sesten_marmoset)
sesten_marmoset$agg_pvalb = get_agg_exp(mouse_subclass_meta_markers, 'Pvalb', num_mouse_markers, sesten_marmoset)
sesten_marmoset$agg_chandelier = get_agg_exp(mouse_subclass_meta_markers, 'Chandelier', num_mouse_markers, sesten_marmoset)
sesten_marmoset$agg_sst = get_agg_exp(mouse_subclass_meta_markers, 'Sst', num_mouse_markers, sesten_marmoset)
sesten_marmoset$agg_sst_chodl = get_agg_exp(mouse_subclass_meta_markers, 'Sst Chodl', num_mouse_markers, sesten_marmoset)

#Alltogether in a hierarchical clustered plot
sesten_marmoset_hierarch_plot = get_hierarch_clust(sesten_marmoset, sesten_marmoset_cluster_markers , 
                                                num_markers = 50,'Sestan marmoset clusters: Mouse MetaMarkers')
sesten_marmoset_hierarch_plot
