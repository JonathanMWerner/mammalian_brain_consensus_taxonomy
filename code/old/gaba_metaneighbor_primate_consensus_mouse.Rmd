...
And try aggregate expression and then z-scores
...
top_pax_markers = top_markers %>% filter(cell_type == 'Pax6') %>% pull(gene)
top_vip_markers = top_markers %>% filter(cell_type == 'Vip') %>% pull(gene)
top_lamp5_markers = top_markers %>% filter(cell_type == 'Lamp5') %>% pull(gene)
top_sncg_markers = top_markers %>% filter(cell_type == 'Sncg') %>% pull(gene)

marker_exp = rowSums(FetchData(interneuron.combined, vars = top_pax_markers, slot = 'data'))
interneuron.combined$agg_pax6_exp = marker_exp
interneuron.combined$scale_agg_pax6_exp = scale(marker_exp)

marker_exp = rowSums(FetchData(interneuron.combined, vars = top_vip_markers, slot = 'data'))
interneuron.combined$agg_vip_exp = marker_exp
interneuron.combined$scale_agg_vip_exp = scale(marker_exp)

marker_exp = rowSums(FetchData(interneuron.combined, vars = top_lamp5_markers, slot = 'data'))
interneuron.combined$agg_lamp5_exp = marker_exp
interneuron.combined$scale_agg_lamp5_exp = scale(marker_exp)

marker_exp = rowSums(FetchData(interneuron.combined, vars = top_sncg_markers, slot = 'data'))
interneuron.combined$agg_sncg_exp = marker_exp
interneuron.combined$scale_agg_sncg_exp = scale(marker_exp)

FeaturePlot(interneuron.combined, features = 'agg_pax6_exp') +
  scale_color_gradient2(low = '#313695', mid ='grey', high = '#A50026', midpoint = 0 )

FeaturePlot(interneuron.combined, features = 'scale_agg_pax6_exp') +
  scale_color_gradient2(low = '#313695', mid ='grey', high = '#A50026', midpoint = 0 )

FeaturePlot(interneuron.combined, features = 'agg_vip_exp') +
  scale_color_gradient2(low = '#313695', mid ='grey', high = '#A50026', midpoint = 0 )

FeaturePlot(interneuron.combined, features = 'scale_agg_vip_exp') +
  scale_color_gradient2(low = '#313695', mid ='grey', high = '#A50026', midpoint = 0 )

FeaturePlot(interneuron.combined, features = 'agg_lamp5_exp') +
  scale_color_gradient2(low = '#313695', mid ='grey', high = '#A50026', midpoint = 0 )

FeaturePlot(interneuron.combined, features = 'scale_agg_lamp5_exp') +
  scale_color_gradient2(low = '#313695', mid ='grey', high = '#A50026', midpoint = 0 )

FeaturePlot(interneuron.combined, features = 'agg_sncg_exp') +
  scale_color_gradient2(low = '#313695', mid ='grey', high = '#A50026', midpoint = 0 )

FeaturePlot(interneuron.combined, features = 'scale_agg_sncg_exp') +
  scale_color_gradient2(low = '#313695', mid ='grey', high = '#A50026', midpoint = 0 )
...
And get average enrichment of marker expression as we increase the number of markers. But I'm specifically interested in:
...
mouse_subclass = paste0('Mouse_', interneuron.combined$cell_subclass)
primate_subclass = paste0('Primate_', interneuron.combined$primate_subclass)
combined_subclass_label = paste(mouse_subclass, primate_subclass, sep = '|')

table(combined_subclass_label)
...
ct_scores = score_cells(log1p(interneuron.combined@assays$originalexp@data), top_markers)
ct_enrichment = compute_marker_enrichment(ct_scores)
colnames(ct_enrichment) = combined_subclass_label

marker_enrich_df = reshape2::melt(t(ct_enrichment), varnames = c('combined_subclass', 'primate_marker_set'), value.name = 'enrichment')

marker_enrich_df %>% group_by(combined_subclass, primate_marker_set) %>% summarise(mean_enrichment = mean(enrichment)) %>%
  group_by(combined_subclass) %>% arrange(desc(mean_enrichment), .by_group = T)
