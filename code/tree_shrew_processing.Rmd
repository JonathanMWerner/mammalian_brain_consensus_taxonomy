...
DimPlot(interneuron.combined, group.by = 'seurat_clusters', label = T)
DimPlot(interneuron.combined, group.by = 'mouse_cge_mge', label = T)
DimPlot(interneuron.combined, group.by = 'primate_cge_mge', label = T)
```
...
colData(tree_shrew_inhibitory_sce)
...
cell_filt = !tree_shrew_inhibitory_sce$seurat_clusters %in% c('0','5','13','18','19','20', '21')
tree_shrew_inhibitory_sce = tree_shrew_inhibitory_sce[ , cell_filt]
...
saveRDS(tree_shrew_inhibitory_sce, file = '/inkwell03/werner/sc_data/tree_shrew_xiong_2025/tree_shrew_sce_GABA_processed.rds')
