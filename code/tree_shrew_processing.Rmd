...
interneuron.combined$mammal_cge_enrich = scale(ct_enrichment['all|CGE', ])
interneuron.combined$mammal_mge_enrich = scale(ct_enrichment['all|MGE', ])
...
FeaturePlot(interneuron.combined, features = c('mammal_cge_enrich'))+ 
  ...
  scale_colour_gradient2(low = "white", mid = "white", high = "black", midpoint = 0)
...
for_ggplot_df$cluster[for_ggplot_df$CGE >= .90 | for_ggplot_df$CGE <= .10] = NA
...
Just use the top 2000 hvgs
```{r}
global_hvgs = global_hvgs[1:2000]
...
0 - Some enrichment for mouse and primate Sst and Sst Chodl, but MNs with mouse Sst and is intermediate with Primate Sst and Sst Chodl. Is closest to Sst generally.
1 - Vip all around
2 - Enrichment for mouse and primate Pax6, some enrichment for primate Sncg. Mouse MN is Pax6, intermediate Pax6 and Sncg for primate MN, But closest tree shrew transcriptomic match is 13, which is a clear Pax6 all around, except with weak mouse Pax6 marker enrichment
3 - Pvalb all around
4 - Lamp5Lhx6 all around
5 - Pax6 all around
6 - Sst all around
7 - Lamp5Lhx6 all around
8 - Pvalb all around
9 - Chandelier all around
10 - Sst outlier with Sst Chodl enrichment for both Primate and Mouse, but is Sst in Mouse and Sst Chodl in Primates. Likely Sst Chodl
11 - Sncg all around
12 - Lamp5 all around
13 - Pax6, but with weak Mouse Pax6 marker enrichment
14 - Seems intermediate with Sst and Sst Chodl, closest match is tree shrew 0 which is mostly Sst
15 - Pax6 all around
16 - No clear enrichment for anything, is Chandelier in primate MN, but between Lamp5Lhx6 and Pvalb in Mouse MN. Likely exclude
17 - No clear enrichment for anything, is Vip and Sncg intermediate in primate MN, but Lamp5 in Mouse MN. Likely exclude
18 - No clear enrichment for anything, is Chandelier in primate MN, but off on its own in the Mouse MN. Likely exclude

16 and 18 are transcriptomically similar and with the other tree shrew Pvalb clusters
17 is transcriptomically similar to tree shrew Lamp5, but more so to 16 and 18.
...
'1' = 'Vip',
'11' = 'Sncg',
'2' = 'Pax6', '5' = 'Pax6', '13' = 'Pax6', '15' = 'Pax6',
'12' = 'Lamp5',
'4' = 'Lamp5Lhx6', '7' = 'Lamp5Lhx6',
...
tree_shrew_clust_subclass_mapping = c('3' = 'Pvalb', '8' = 'Pvalb',
'9' = 'Chandelier',
'0' = 'Sst', '6' = 'Sst', '14' = 'Sst',
'10' = 'Sst Chodl',
'1' = 'Vip',
