...
``` r
load(file = 'data_for_plots/sestan_namesake_fc.Rdata')
...
![](figure_plots_with_data_code_files/figure-gfm/non_allen_MGE_CGE_FC-1.png)<!-- -->

``` r
load(file = 'data_for_plots/caglayan_namesake_fc.Rdata')
...
![](figure_plots_with_data_code_files/figure-gfm/non_allen_MGE_CGE_FC-2.png)<!-- -->
...
load(file = 'data_for_plots/sesten_primate_cluster_tax_data.Rdata')

centroid_corr = sesten_hierarch_plot[[2]]
hclust_avg = sesten_hierarch_plot[[3]]
column_annotation = sesten_hierarch_plot[[4]]

corr_cols <- rev(grDevices::colorRampPalette(RColorBrewer::brewer.pal(11,"RdYlBu"))(100))
cent_hm = ComplexHeatmap::Heatmap(centroid_corr, col = corr_cols, name = 'spearman' ,
                                  cluster_columns = hclust_avg,
                                  cluster_rows = hclust_avg,
                                  column_title = 'Sestan Primate clusters: Allen primate MetaMarkers',
                                  top_annotation = column_annotation)
cent_hm = ComplexHeatmap::draw(cent_hm)
```

![](figure_plots_with_data_code_files/figure-gfm/non_allen_marker_tax-1.png)<!-- -->

``` r
load(file = 'data_for_plots/sesten_mouse_cluster_tax_data.Rdata')
...
cent_hm = ComplexHeatmap::Heatmap(centroid_corr, col = corr_cols, name = 'spearman' ,
                                  cluster_columns = hclust_avg,
                                  cluster_rows = hclust_avg,
                                  column_title = 'Sestan Primate clusters: Mouse MetaMarkers',
                                  top_annotation = column_annotation)
cent_hm = ComplexHeatmap::draw(cent_hm)
```

![](figure_plots_with_data_code_files/figure-gfm/non_allen_marker_tax-2.png)<!-- -->

``` r
#Panel 5E

load(file = 'data_for_plots/caglayan_primate_cluster_tax_data.Rdata')

centroid_corr = caglayan_hierarch_plot[[2]]
hclust_avg = caglayan_hierarch_plot[[3]]
column_annotation = caglayan_hierarch_plot[[4]]

corr_cols <- rev(grDevices::colorRampPalette(RColorBrewer::brewer.pal(11,"RdYlBu"))(100))
cent_hm = ComplexHeatmap::Heatmap(centroid_corr, col = corr_cols, name = 'spearman' ,
                                  cluster_columns = hclust_avg,
                                  cluster_rows = hclust_avg,
                                  column_title = 'Caglayan Primate clusters: Allen primate MetaMarkers',
                                  top_annotation = column_annotation)
cent_hm = ComplexHeatmap::draw(cent_hm)
```

![](figure_plots_with_data_code_files/figure-gfm/non_allen_marker_tax-3.png)<!-- -->

``` r
load(file = 'data_for_plots/caglayan_mouse_cluster_tax_data.Rdata')
...
cent_hm = ComplexHeatmap::Heatmap(centroid_corr, col = corr_cols, name = 'spearman' ,
                                  cluster_columns = hclust_avg,
                                  cluster_rows = hclust_avg,
                                  column_title = 'Caglayan Primate clusters: Mouse MetaMarkers',
                                  top_annotation = column_annotation)
cent_hm = ComplexHeatmap::draw(cent_hm)
```

![](figure_plots_with_data_code_files/figure-gfm/non_allen_marker_tax-4.png)<!-- -->

## FIgure 5 B and F

``` r
load(file = 'data_for_plots/sesten_primate_confuse_mat.Rdata')
...
![](figure_plots_with_data_code_files/figure-gfm/non_allen_confuse_mats-1.png)<!-- -->

``` r
load(file = 'data_for_plots/caglayan_primate_confuse_mat.Rdata')
...
![](figure_plots_with_data_code_files/figure-gfm/non_allen_confuse_mats-2.png)<!-- -->

## Figure 5 C and D

``` r
load( file = 'data_for_plots/sestan_primate_vip_sncg.Rdata')

ggplot(sestan_primate_vip_sncg_df, aes(x = `mean_enrichment_all|Vip`, y = `mean_enrichment_all|Sncg`, color = subclass, label = de_novo_cluster)) + 
...
![](figure_plots_with_data_code_files/figure-gfm/yale_scatter-1.png)<!-- -->

``` r
load( file = 'data_for_plots/sestan_mouse_vip_sncg.Rdata')

ggplot(sestan_mouse_vip_sncg_df, aes(x = `all|Vip`, y = `all|Sncg`, color = subclass, label = de_novo_cluster)) + 
  geom_point(size = 4, show.legend = F) +
  geom_label_repel(min.segment.length = 0, show.legend = F, force_pull = .1, box.padding = .5) +
  geom_abline(intercept = 0, slope = 1, linetype = 'dashed', color = 'black') +
  scale_color_manual(values = celltype_color_palette) +
...
![](figure_plots_with_data_code_files/figure-gfm/yale_scatter-2.png)<!-- -->

## Figure 5 G and H

``` r
load( file = 'data_for_plots/caglayan_primate_vip_sncg.Rdata')

ggplot(caglayan_primate_vip_sncg_df, aes(x = `mean_enrichment_all|Vip`, y = `mean_enrichment_all|Sncg`, color = subclass, label = de_novo_cluster)) + 
  geom_point(size = 4, show.legend = F) +
  geom_label_repel(min.segment.length = 0, show.legend = F, force_pull = .1, box.padding = .5) +
  geom_abline(intercept = 0, slope = 1, linetype = 'dashed', color = 'black') +
  scale_color_manual(values = celltype_color_palette) +
...
![](figure_plots_with_data_code_files/figure-gfm/texas_scatter-1.png)<!-- -->

``` r
load( file = 'data_for_plots/caglayan_mouse_vip_sncg.Rdata')

ggplot(caglayan_mouse_vip_sncg_df, aes(x = `all|Vip`, y = `all|Sncg`, color = subclass, label = de_novo_cluster)) + 
  geom_point(size = 4, show.legend = F) +
  geom_label_repel(min.segment.length = 0, show.legend = F, force_pull = .1, box.padding = .5) +
  geom_abline(intercept = 0, slope = 1, linetype = 'dashed', color = 'black') +
  scale_color_manual(values = celltype_color_palette) +
...
![](figure_plots_with_data_code_files/figure-gfm/texas_scatter-2.png)<!-- -->

## FIgure 6A Yale primate panels

``` r
load(file = 'data_for_plots/sestan_primate_vip_enrich_dot.Rdata')
...
![](figure_plots_with_data_code_files/figure-gfm/yale_primate_enrich_dot_plots-1.png)<!-- -->

``` r
load(file = 'data_for_plots/sestan_primate_pax6_enrich_dot.Rdata')
...
![](figure_plots_with_data_code_files/figure-gfm/yale_primate_enrich_dot_plots-2.png)<!-- -->

``` r
load(file = 'data_for_plots/sestan_primate_sncg_enrich_dot.Rdata')
...
![](figure_plots_with_data_code_files/figure-gfm/yale_primate_enrich_dot_plots-3.png)<!-- -->

``` r
load(file = 'data_for_plots/sestan_mouse_sncg_enrich_dot.Rdata')
...
![](figure_plots_with_data_code_files/figure-gfm/yale_primate_enrich_dot_plots-4.png)<!-- -->

## FIgure 6A Texas primate panels

``` r
load(file = 'data_for_plots/caglayan_primate_vip_enrich_dot.Rdata')
...
![](figure_plots_with_data_code_files/figure-gfm/texas_primate_enrich_dot_plots-1.png)<!-- -->

``` r
load(file = 'data_for_plots/caglayan_primate_pax6_enrich_dot.Rdata')
...
![](figure_plots_with_data_code_files/figure-gfm/texas_primate_enrich_dot_plots-2.png)<!-- -->

``` r
load(file = 'data_for_plots/caglayan_primate_sncg_enrich_dot.Rdata')
...
ggplot(plotting_df, aes(x = de_novo_cluster, y = mean_enrichment, color = mapped_primate_subclass)) +
  ...
  geom_linerange(aes(ymin = mean_enrichment - sd_enrichment, ymax = mean_enrichment + sd_enrichment),
                 show.legend = F) +
  geom_hline(yintercept = 1, linetype = 'dashed', color = 'black') +
  ylab('Mean Primate Sncg enrichment') + xlab('UT SouthWestern cross-primate de novo clusters') + ylim(0,3) +
  scale_x_discrete(guide = guide_axis(n.dodge=2)) +
  scale_color_manual(values = celltype_color_palette) +
  theme_bw() + theme(panel.border = element_blank(), axis.line = element_line(),
                     panel.grid.major = element_blank(),
...
![](figure_plots_with_data_code_files/figure-gfm/texas_primate_enrich_dot_plots-3.png)<!-- -->

``` r
load(file = 'data_for_plots/caglayan_mouse_sncg_enrich_dot.Rdata')
...
![](figure_plots_with_data_code_files/figure-gfm/texas_primate_enrich_dot_plots-4.png)<!-- -->
